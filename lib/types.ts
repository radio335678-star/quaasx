...
import type { Ai2AnswerLayout } from "./ai2/types";
...
export const messageMetadataSchema = z.object({
  ...
  scopedWorks: z.array(z.string()).max(3).optional(),
  scopedAbbrevs: z.array(z.string()).max(3).optional(),
});
